...
import type { ProductHeroProps } from '@/types/public';
import { cn } from '@/lib/utils';

/**
 * Full-width hero cover image component for the public product detail page.
 * Displays optimized cover image with priority loading in a sharp monolithic frame.
 */
export function ProductHero({ coverImage, title, className }: ProductHeroProps) {
